...
inline Ray ScreenToWorldRay(float xpos, float ypos, int SCR_WIDTH, int SCR_HEIGHT, glm::mat4 projection, glm::mat4 view) {
...
inline bool RayPlaneIntersection(const Ray& ray, const glm::vec3& planeNormal, const glm::vec3& planePoint, float& t)
{
